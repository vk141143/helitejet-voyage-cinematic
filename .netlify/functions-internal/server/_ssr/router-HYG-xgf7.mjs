...
import { T as worldHead, _ as menu, a as ScrollTrack, l as brand, p as ease, w as useCinematicMotion, x as scenes } from "./CinematicPage-5SbnHwRf.mjs";
import { t as world } from "./about-BUY-cW0c.mjs";
import { t as world$1 } from "./aviation-BT22Khii.mjs";
import { t as world$2 } from "./concierge-B7W2aILR.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
import { t as world$3 } from "./destinations-DzBOyj-X.mjs";
import { t as world$4 } from "./experiences-DUjbj4Z5.mjs";
import { t as world$5 } from "./membership-DhbcXTB5.mjs";
import { t as world$6 } from "./mobility-Bz3d3dtW.mjs";
import { t as world$7 } from "./private-CWEntcMu.mjs";
import { t as world$8 } from "./request-access-DVt0AMPI.mjs";
import { t as world$9 } from "./residences-XmFOqnSg.mjs";
import { t as world$10 } from "./routes-bX75oGJn.mjs";
import { t as world$11 } from "./subscriptions-By9hznxm.mjs";
import { t as world$12 } from "./yachts-CZaqWO5m.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-HYG-xgf7.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-DEZB8uQv.css";
...
var $$splitComponentImporter$12 = () => import("./routes-lS6cC8kd.mjs");
var Route$12 = createFileRoute("/")({
	head: () => worldHead(world$10),
	component: lazyRouteComponent($$splitComponentImporter$12, "component")
});
var $$splitComponentImporter$11 = () => import("./about-r8FHRcdY.mjs");
var Route$11 = createFileRoute("/about")({
	head: () => worldHead(world),
	component: lazyRouteComponent($$splitComponentImporter$11, "component")
});
var $$splitComponentImporter$10 = () => import("./aviation-CffWRZ1j.mjs");
var Route$10 = createFileRoute("/aviation")({
	head: () => worldHead(world$1),
	component: lazyRouteComponent($$splitComponentImporter$10, "component")
});
var $$splitComponentImporter$9 = () => import("./concierge-Cfds3mBb.mjs");
var Route$9 = createFileRoute("/concierge")({
	head: () => worldHead(world$2),
	component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
var $$splitComponentImporter$8 = () => import("./destinations-Ba_uenrd.mjs");
var Route$8 = createFileRoute("/destinations")({
	head: () => worldHead(world$3),
	component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
var $$splitComponentImporter$7 = () => import("./experiences-uLXu7T57.mjs");
var Route$7 = createFileRoute("/experiences")({
	head: () => worldHead(world$4),
	component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
var $$splitComponentImporter$6 = () => import("./membership-Do35639_.mjs");
var Route$6 = createFileRoute("/membership")({
	head: () => worldHead(world$5),
	component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
var $$splitComponentImporter$5 = () => import("./mobility-CW5MZXeB.mjs");
var Route$5 = createFileRoute("/mobility")({
	head: () => worldHead(world$6),
	component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
var $$splitComponentImporter$4 = () => import("./private-BtxwjQxN.mjs");
var Route$4 = createFileRoute("/private")({
	head: () => worldHead(world$7),
	component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
var $$splitComponentImporter$3 = () => import("./request-access-B1cpFqLp.mjs");
var Route$3 = createFileRoute("/request-access")({
	head: () => worldHead(world$8),
	component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
var $$splitComponentImporter$2 = () => import("./residences-BZMhcMDu.mjs");
var Route$2 = createFileRoute("/residences")({
	head: () => worldHead(world$9),
	component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
var $$splitComponentImporter$1 = () => import("./subscriptions-DE3OYPC-.mjs");
var Route$1 = createFileRoute("/subscriptions")({
	head: () => worldHead(world$11),
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var $$splitComponentImporter = () => import("./yachts-CRywhQFT.mjs");
...
var rootRouteChildren = {
	...
	AviationRoute: Route$10.update({
		id: "/aviation",
		path: "/aviation",
		getParentRoute: () => Route$13
	}),
	ConciergeRoute: Route$9.update({
		id: "/concierge",
		path: "/concierge",
		getParentRoute: () => Route$13
	}),
	DestinationsRoute: Route$8.update({
		id: "/destinations",
		path: "/destinations",
		getParentRoute: () => Route$13
	}),
	ExperiencesRoute: Route$7.update({
		id: "/experiences",
		path: "/experiences",
		getParentRoute: () => Route$13
	}),
	MembershipRoute: Route$6.update({
		id: "/membership",
		path: "/membership",
		getParentRoute: () => Route$13
	}),
	MobilityRoute: Route$5.update({
		id: "/mobility",
		path: "/mobility",
		getParentRoute: () => Route$13
	}),
	PrivateRoute: Route$4.update({
		id: "/private",
		path: "/private",
		getParentRoute: () => Route$13
	}),
	RequestAccessRoute: Route$3.update({
		id: "/request-access",
		path: "/request-access",
		getParentRoute: () => Route$13
	}),
	ResidencesRoute: Route$2.update({
		id: "/residences",
		path: "/residences",
		getParentRoute: () => Route$13
	}),
	SubscriptionsRoute: Route$1.update({
		id: "/subscriptions",
		path: "/subscriptions",
		getParentRoute: () => Route$13
	}),
